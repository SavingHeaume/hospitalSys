...
public class LoginController {
  ...
  @ResponseBody
  public JSONObject login_android(@RequestBody Login login) {
    JSONObject json = new JSONObject();
    login = loginService.findIdByUsername(login.getUsername());
    json.put("message", loginService.login(login));
    json.put("loginId", login.getId());
    System.out.println("android用户登录");
    return json;
  }
